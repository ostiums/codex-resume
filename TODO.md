...
- [ ] **Картинки как настоящие изображения.** Сейчас `input_image` из Codex превращается в текст
...
- [ ] **cwd из последнего `turn_context`**, а не из `session_meta` (так сделано в форке
